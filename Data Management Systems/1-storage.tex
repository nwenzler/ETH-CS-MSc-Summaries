...
Correct linked list storing block header is found by hashing on some form of block identifier. %TODO more? why bucket? how?
...
What to cache, what to keep, how to evict and when, how to avoid thrashing cache with unnecessary traffic. %TODO more?
...
%TODO analytical queries vs transactions/other - more complex, lots of data
%TODO more? or just paper
